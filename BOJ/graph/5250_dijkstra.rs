...
fn main() {
    ...
    let lucky_edges: HashSet<_> = lucky_path
        .windows(2)
    ...
    while let Some((Reverse(d_u), u, p, w)) = pq.pop() {
        ...
        if closest_lucky_node_src[u as usize].0 == UNSET {
            closest_lucky_node_src[u as usize] = (
                closest_lucky_node_src[p as usize].0,
                closest_lucky_node_src[p as usize].1 + w,
            );
        }
    ...
    while let Some((Reverse(d_u), u, p, w)) = pq.pop() {
        ...
        if closest_lucky_node_dest[u as usize].0 == UNSET {
            closest_lucky_node_dest[u as usize] = (
                closest_lucky_node_dest[p as usize].0,
                closest_lucky_node_dest[p as usize].1 + w,
            );
        }
    ...
    for &(u, (v, w)) in &edges {
        ...
        if d < INF {
            ans.apply_range(ps as usize..pe as usize, d);
        }
    }
